							...
							<table class="table table-striped table-bordered table-hover"
								...
								<%
									stmt1.executeUpdate("CREATE VIEW BuyingHistory(ItemID, ItemName, ItemType, Num) AS "
										...
										rs = stmt1
												.executeQuery("SELECT I.ItemID, I.ItemName, I.ItemType, I.Description "
								...
								%>
								<tr>
									<form name="myForm" action="ItemInformation.jsp"
										method="post" role="form">
										<td style="width: 80px"><span style="font-size: 10pt">
												<input type="hidden" value="<%=rs.getString(1)%>" name="iID">
												<input type="submit" value="<%=rs.getString(1)%>"
												onclick="return Button1_onclick()">
										</span></td>
									</form>
