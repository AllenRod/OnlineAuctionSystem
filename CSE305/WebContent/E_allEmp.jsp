...
<title>Customer Representative Employee Info - OAS</title>
								...
								try {
									...
									java.sql.ResultSet rs = stmt1
											.executeQuery("SELECT P.LastName, P.FirstName, P.Address, P.City, "
													+ "P.State, P.ZipCode, P.Telephone, E.SSN, E.StartDate, E.Level "
													+ "FROM person P, employee E WHERE P.ID = E.EmployeeID ORDER BY LastName;");
									while (rs.next()) {
							%>
							<tr>
								...
								<td ><span style="font-size: 10pt"><%=rs.getString(10)%></span></td>
							</tr>
							<%
								}
								} catch (Exception e) {
