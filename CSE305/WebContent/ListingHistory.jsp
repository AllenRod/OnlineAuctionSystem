						...
						<table class="table table-striped table-bordered table-hover"
							...
							<%
								...
								try {
									...
									java.sql.ResultSet rs = stmt1.executeQuery("SELECT L.AuctionID, A.ItemID, I.ItemName, I.ItemType, L.ClosingDate FROM List L, Auction A, Item I WHERE L.SellerID='"
													+ userID
							...
							<tr>
								...
								<form name="myForm" action="ItemInformation.jsp" method="post"
									role="form">
									<td style="width: 80px"><span style="font-size: 10pt">
											<input type="hidden" value="<%=rs.getString(2)%>" name="iID">
