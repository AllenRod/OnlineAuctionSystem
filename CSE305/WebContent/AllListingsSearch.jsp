						...
						<tbody>
							<%
								...
								try {
									...
									String query = "SELECT A.AuctionID, L.SellerID, A.ItemID, I.ItemName, I.ItemType, A.CurrentBid, L.ClosingDate"
											+ " FROM Item I, Auction A, List L"
											+ " WHERE A.AuctionID = L.AuctionID and A.ItemID = I.ItemID";
									if (!iType.equalsIgnoreCase("")) {
										System.out.println(iType.getClass()+":"+iType);
										query = query + " and I.ItemType = '" + iType + "'";
									}
									
									if (keyword != "") {
										for (int i = 0; i < keywords.length; i++) {
											System.out.println(keywords[i]);
											query = query + " and (I.ItemName LIKE '%" + keywords[i] + "%' or I.Description LIKE '%" + keywords[i] + "%')";
										}
									}
